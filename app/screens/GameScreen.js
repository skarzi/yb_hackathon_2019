...
export default class GameScreen extends React.Component {
  ...
  nextQuestion() {
    ...
    this.fetchQuestion(currentTime);
  }
  ...
  renderAnswer({ item, index }) {
    ...
    return (
      <View style={Object.assign({}, styles.guess, styleAnswerKeys)}>
        <Button 
